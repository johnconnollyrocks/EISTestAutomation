...
/**
 * Test class - TestEditUpdateUserResubmitAccount
 * 
 * @author Vithyusha Revuri
 * @author : Modified by Brijesh Chavda
 * @version 1.0.0
 */
public final class TestEditUpdateUserOverrideTrilliumProcess extends MJATestBase {
	public TestEditUpdateUserOverrideTrilliumProcess() {
		super();
	}
	...
	@Test
	public void TEST_EditUpdateUserResubmitAccount() throws Exception {
	...
	//	loginAsAutoUser();
		...
		editUpdateUserbyURLOverrideTrillumProcess(allUsersURLArray, userApprovalRequestEmailStatus);
	}
	@After
