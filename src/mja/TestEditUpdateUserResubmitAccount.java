 ...
 * @version 1.0.0
 */
public final class TestEditUpdateUserResubmitAccount extends MJATestBase {
	public TestEditUpdateUserResubmitAccount() {
		super();
	}
	...
	//	loginAsAutoUser();
		...
		editUpdateUserbyURLResubmitAccount(allUsersURLArray, userApprovalRequestEmailStatus);
	}
	@After
