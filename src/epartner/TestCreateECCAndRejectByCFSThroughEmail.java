 ...
 * @version 1.0.0
 */
public final class TestCreateECCAndRejectByCFSThroughEmail extends EpartnerTestBase {
	public TestCreateECCAndRejectByCFSThroughEmail() {
		super("chrome");
	}
...
//		endCustomerContractPage.clickAndWait("approveRejectLinkForFirstAgreement", "approveButton");
		...
		//16. LOGIN TO CFS'S EMAIL
		loginToGmail(testProperties.getConstant("GEO_CFS_EMAIL"), testProperties.getConstant("GEO_CFS_MAIL_PASSWORD"));
				
		//17. VERIFY CFS RECEIVES MAIL; OPEN MAIL
		verifyGmailExists("is:Unread subject:(" + testProperties.getConstant("EMAIL_SUBJECT") + ") from:" + testProperties.getConstant("FBP_EMAIL"));
		openFirstGmail();
				
		//18. REJECT ECC BY EMAIL
