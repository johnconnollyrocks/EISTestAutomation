...
import common.Util;
import epartner.EpartnerConstants;
...
public class EpartnerTestBase extends EISTestBase {
	private static final String APP_NAME		= "ePartner";
	private static final String APP_BASE_DIR	= "epartner";
	...
	final Partner utilCreatePartnerOpportunityObject(TestProperties utilProperties) {
		...
		Page_ createEndCustomerContractPage			= createPage(utilProperties, "PAGE_END_CUST_AGREEMENT_PROPERTIES_FILE");
		Page_ viewAccountPage		= createCommonPageInstance(utilProperties, "PAGE_VIEW_ACCOUNT_PROPERTIES_FILE");
		partnerOpportunity = new Partner(createPartnerOpportunityPage, viewPartnerOpportunityPage,viewAccountDetailsPage,createEndCustomerContractPage,viewAccountPage);
     	return partnerOpportunity;
    }
