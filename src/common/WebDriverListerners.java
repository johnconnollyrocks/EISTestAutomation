...
//  System.out.println("After Navigating To: " + url + ", my url is: "+ driver.getCurrentUrl());
	 EISTestBase.reportStep("Navigating to URL: ", driver.getCurrentUrl() );
 }
...
//	 String elementName=(String)element.getAttribute("id");
...
//	  }
//	 ;
//  System.out.println("Selected Element with: '" + element + "'");
 }
 ...
 public void afterChangeValueOf(WebElement element, WebDriver driver) {
  ...
  if (changedValue.isEmpty()) {
   changedValue = element.getAttribute("value");
	...
	if (!changedValue.isEmpty()){
//		 report.reportStep("Changing value in element found " + elementName
//				    + " from '" + originalValue + "' to '" + changedValue + "'");
		 EISTestBase.reportStep("Enter value in edit field '"+elementName+"'", changedValue );
 ...
 */
 ...
 // TODO Auto-generated method stub
//	  System.out.println("Executed script for operating element with"+ script);
       }
}