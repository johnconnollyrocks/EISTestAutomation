...
public class Test_Add_MoreUsers_1 extends CustomerPortalTestBase {
	public Test_Add_MoreUsers_1() throws IOException {
...
//		super();
	...
	public void Test_Verify_OnlineMap() throws Exception {
		...
		Util.sleep(10000);
		driver.findElement(By.xpath(".//*[@id='benefits_110000860147_0']")).click();
		Util.sleep(10000);
//		homePage.populateField("AssignContract");
		homePage.click("AssignContract2");
//		homePage.populateField("AssignWebSupport");
		homePage.click("AssignWebSupport1");
//		homePage.populateField("AssignPrd");
		driver.findElement(By.xpath(".//*[@id='benefits_110000860147_0']")).click();
		homePage.click("AssignPrd1");
