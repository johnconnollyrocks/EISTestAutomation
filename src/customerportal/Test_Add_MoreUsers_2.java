...
public class Test_Add_MoreUsers_2 extends CustomerPortalTestBase {
	public Test_Add_MoreUsers_2() throws IOException {
...
//		super();
	...
	public void Test_Verify_OnlineMap() throws Exception {
		...
		Util.sleep(10000);
		driver.findElement(By.xpath(".//*[@id='benefits_110000858204_0']")).click();
		Util.sleep(10000);
//		homePage.populateField("AssignContract");
		homePage.click("AssignContract3");
//		homePage.populateField("AssignWebSupport");
		homePage.click("AssignWebSupport2");
//		homePage.populateField("AssignPrd");
		driver.findElement(By.xpath(".//*[@id='benefits_110000858204_0']")).click();
		homePage.click("AssignPrd2");
