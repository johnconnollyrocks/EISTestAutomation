 ...
 * @version 1.0.0
 */
public final class Test_VerifyEUContractRptHeaders extends CustomerPortalTestBase {
	public Test_VerifyEUContractRptHeaders() throws IOException {
...
//		super();
	...
	public void Test_VerifyCMContractRptHeaders_method() throws Exception {
		...
		Util.printInfo("check if total columns = 7");
