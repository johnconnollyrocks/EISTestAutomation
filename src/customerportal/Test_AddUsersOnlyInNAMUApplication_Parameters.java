...
public final class Test_AddUsersOnlyInNAMUApplication_Parameters extends CustomerPortalTestBase {
	@Rule
	public MethodRule ScreenshotTestRule  = new ScreenshotTestRule();
	public Test_AddUsersOnlyInNAMUApplication_Parameters(String browser) throws IOException {
		super("Browser",browser,"Para");
		sysProps.setProperty("testName","Test_AddUsersOnlyInNAMUApplication_Parameters");
		sysProps.setProperty("testPropertiesFilenameKey","TEST_ADD_USERS_ONLY_PROPERTIES_FILE");
		setup();
//		super();
