...
public class Test_Verfy_ProductUpdatesFilterByStatus extends CustomerPortalTestBase{

	public Test_Verfy_ProductUpdatesFilterByStatus() throws IOException {
...
//		homePage.clickAndWait("dateFilter", "appliedFilterDate");
		homePage.click("statusFilter");
		homePage.verifyFieldExists("appliedFilterStatus");
