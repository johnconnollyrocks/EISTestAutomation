...
public final class Test_AddUsersOnlyInNAMUApplication_BatchTest extends CustomerPortalTestBase {
	@Rule
	public MethodRule ScreenshotTestRule  = new ScreenshotTestRule();
	public Test_AddUsersOnlyInNAMUApplication_BatchTest(String browser) throws IOException {
