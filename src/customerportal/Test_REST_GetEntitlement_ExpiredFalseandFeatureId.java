 ...
 * @version 1.0.0
 */
public final class Test_REST_GetEntitlement_ExpiredFalseandFeatureId {
	
	@Test
	public void Test_REST_GetEntitlement_ExpiredFalseandFeatureId_Method() throws ClientProtocolException, IOException {
		
		String jsonMimeType = "application/json";	
		HttpClient client = new DefaultHttpClient();
		HttpGet request = new HttpGet("https://ent-dev.autodesk.com/service/entitlements/v1/user/GM0KBG502JKF?includeExpired=false&featureId=FSN360");
