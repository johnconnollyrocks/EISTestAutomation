 ...
 * @version 1.0.0
 */
public final class Test_Verify_Contract_Row_Drawer_Redesign_NoCCused extends CustomerPortalTestBase {
	public Test_Verify_Contract_Row_Drawer_Redesign_NoCCused() throws IOException {
...
//		 homePage.click("contractDrawerNoCCused");
	...
	String clouds_consumed=null;
	if(cloud_consumed==0){
		clouds_consumed="No cloud credits used on any service";
