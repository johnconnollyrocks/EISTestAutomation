 ...
 * @version 1.0.0
 */
public final class Test_Verify_CloudCredit_NewUser extends CustomerPortalTestBase {
	
	
	public Test_Verify_CloudCredit_NewUser() throws IOException {
...
//		super();
	...
	@Test
	public void Test_Verify_CloudCredit_NewUser_method() throws Exception {
		//setDebugMode(true);
...
//		}
		...
		for(int i =1;i<=rows;i++){
			...
			//2nd scenario : Assign user to all contracts, and verify the same making the SOAPUI call. 
