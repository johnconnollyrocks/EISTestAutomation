 ...
 * @version 1.0.0k
 */
public final class Test_REST_GetEntitlement_ExpiredTrueandFeatureId extends BornInCloudTestBase{
	
	public Test_REST_GetEntitlement_ExpiredTrueandFeatureId() throws IOException {
	...
	@Test
	public void Test_REST_GetEntitlement_ExpiredTrueandFeatureId_Method() throws Exception {
		...
		HttpResponse response = getEntitlement(client, testDataMap.get("url"), testDataMap.get("userId"), "?includeExpired=true&featureId=FSN360");
