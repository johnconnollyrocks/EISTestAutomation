...
/**
 * Test class - Test_REST_GetEntitlement_ExpiredTrueandOfferingIdandFeatureId
 * 
 * @author Brijesh Chavda
 * @version 1.0.0
 */
public final class Test_REST_GetEntitlement_ExpiredTrueandOfferingIdandFeatureId extends BornInCloudTestBase{
	
	public Test_REST_GetEntitlement_ExpiredTrueandOfferingIdandFeatureId() throws IOException {
	...
	@Test
	public void Test_REST_GetEntitlement_ExpiredTrueandOfferingIdandFeatureId_Method() throws Exception {
		...
		HttpResponse response = getEntitlement(client, testDataMap.get("url"), testDataMap.get("userId"), "?includeExpired=true&offeringId=FSN360-TRIAL&featureId=ID3");
