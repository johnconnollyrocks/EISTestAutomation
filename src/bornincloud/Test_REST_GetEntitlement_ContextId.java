...
/**
 * Test class - Test_REST_GetEntitlement_ContextId
 * 
 * @author Brijesh Chavda
 * @version 1.0.0
 */
public final class Test_REST_GetEntitlement_ContextId extends BornInCloudTestBase{
	
	public Test_REST_GetEntitlement_ContextId() throws IOException {
	...
	@Test
	public void Test_REST_GetEntitlement_ContextId_Method() throws Exception {		
		...
		HttpResponse response = getEntitlement(client,testDataMap.get("url"), testDataMap.get("userId"), "?contextId="+testDataMap.get("contextId"));
