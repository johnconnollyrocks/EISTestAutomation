 ...
 * @version 1.0.0
 */
public final class Test_BUUC_SOAP_ConvergentCharging_CASUAL_USE extends
		BornInCloudTestBase {
	String response="";
	String contract="";
	...
	public Test_BUUC_SOAP_ConvergentCharging_CASUAL_USE() throws IOException {
	...
	@Test
	public void Test_BUUC_SOAP_ConvergentCharging_CASUAL_USE_Method()
			throws Exception {
		...
		// *******************
		XMLConfiguration xmlresponseFileAfter = new XMLConfiguration(responsexmlFileAfter);
		...
		HierarchicalConfiguration myConfig2 = xmlresponseFileAfter.configurationAt(respHeaderAfter);
