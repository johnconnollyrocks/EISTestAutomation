...
/**
 * Test class - Test_REST_GetEntitlement_ExpiredFalseandFeatureId
 * 
 * @author Brijesh Chavda
 * @version 1.0.0k
 */
public final class Test_REST_GetEntitlement_ExpiredFalseandFeatureId extends BornInCloudTestBase{
	
	public Test_REST_GetEntitlement_ExpiredFalseandFeatureId() throws IOException {
	...
	@Test
	public void Test_REST_GetEntitlement_ExpiredFalseandFeatureId_Method() throws Exception {
		...
		HttpResponse response = getEntitlement(client, testDataMap.get("url"), testDataMap.get("userId"), "?includeExpired=false&featureId=FSN360");
