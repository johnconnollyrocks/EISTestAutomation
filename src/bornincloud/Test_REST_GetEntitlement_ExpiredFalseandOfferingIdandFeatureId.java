 ...
 * @version 1.0.0
 */
public final class Test_REST_GetEntitlement_ExpiredFalseandOfferingIdandFeatureId extends BornInCloudTestBase{
	
	public Test_REST_GetEntitlement_ExpiredFalseandOfferingIdandFeatureId() throws IOException {
	...
	@Test
	public void Test_REST_GetEntitlement_ExpiredFalseandOfferingIdandFeatureId_Method() throws Exception {
		...
		HttpResponse response = getEntitlement(client, testDataMap.get("url"), testDataMap.get("userId"), "?includeExpired=false&offeringId=FSN360-TRIAL&featureId=ID3");
