 ...
 * @version 1.0.0
 */
public final class Test_IPP_REST_Create_Shopper extends BornInCloudTestBase {
	...
	public Test_IPP_REST_Create_Shopper() throws IOException {
	...
	@Test
	public void Test_IPP_REST_Create_Shopper_Method() throws Exception {
...
//			    assertTrue("Assert : Verifying the Json Response from Rest Create Service", actualjsondata.toUpperCase().contains(expectedResponceJson.toUpperCase()));
