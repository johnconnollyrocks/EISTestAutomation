 ...
 * @version 1.0.0
 */
public final class Test_IPP_REST_Create_GetTax_without_TaxAmt extends BornInCloudTestBase {
	...
	public Test_IPP_REST_Create_GetTax_without_TaxAmt() throws IOException {
	...
	@Test
	public void Test_IPP_REST_GetTax_With_Out_Tax_Amount() throws Exception {
		...
		// Parsing test data values from test data file and creating a test data Hash
				...
				HttpResponse response = createEntitlement(client, testDataMap.get("ippRequest").replace("user", "tax"), "", actualRequestJson, testDataMap.get("jsonMimetype"));	
...
//			    
//			    String amount=getValueOfTagFromJsaon(actualRequestJson, "amount");
//			    String tax=getValueOfTagFromJsaon(actualjsondata, "tax");
//			    int total=Integer.parseInt(amount)+Integer.parseInt(tax);
//			    
//			    assertTrue("Expected total amount had recived from responce",getValueOfTagFromJsaon(actualjsondata, "total").equals(""+total));
	...
	public String getValueOfTagFromJsaon(String JsonString, String tagName){
		tagName="\""+tagName.toUpperCase()+"\":";
		String temp[]=JsonString.toUpperCase().replace(" ", "").split(tagName.toUpperCase());
