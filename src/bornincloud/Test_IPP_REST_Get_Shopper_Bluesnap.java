 ...
 * @version 1.0.0
 */
public final class Test_IPP_REST_Get_Shopper_Bluesnap extends BornInCloudTestBase {
	
	public Test_IPP_REST_Get_Shopper_Bluesnap() throws IOException {
	...
	@Test
	public void Test_IPP_REST_Get_Shopper_Bluesnap_Method() throws Exception {
		...
		// Parsing test data values from test data file and creating a test data Hash
				...
				// Verifying the Json Response from Rest Get Service 
//				System.out.println("Assert : Verify the actual Json Repsonse" + "\n");
//				compareStrings(testDataMap.get("expectedjsondata").replace(" ", ""), actualjsondata.replace(" ", ""));	 
