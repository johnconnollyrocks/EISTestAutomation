...
/**
 * Test class - Test_REST_GetEntitlement_Negative_ExistingUserNonExistingOffering
 * 
 * @author Brijesh Chavda
 * @version 1.0.0
 */
public final class Test_REST_GetEntitlement_Negative_ExistingUserNonExistingOffering extends BornInCloudTestBase{
	
	public Test_REST_GetEntitlement_Negative_ExistingUserNonExistingOffering() throws IOException {
	...
	@Test
	public void Test_REST_GetEntitlement_Negative_ExistingUserNonExistingOffering_Method() throws Exception {		
		...
		HttpResponse response = getEntitlement(client,testDataMap.get("url"), testDataMap.get("userId"), "?offeringId=none");
