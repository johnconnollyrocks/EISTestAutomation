 ...
 * @version 1.0.0
 */
public final class Test_REST_GetEntitlement_ExpiredFalse extends BornInCloudTestBase{
	
	public Test_REST_GetEntitlement_ExpiredFalse() throws IOException {
	...
	@Test
	public void Test_REST_GetEntitlement_ExpiredFalse_Method() throws Exception {
		...
		HttpResponse response = getEntitlement(client, testDataMap.get("url"), testDataMap.get("userId"), "?includeExpired=false");
