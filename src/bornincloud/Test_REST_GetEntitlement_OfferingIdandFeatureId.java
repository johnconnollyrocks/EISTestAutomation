 ...
 * @version 1.0.0
 */
public final class Test_REST_GetEntitlement_OfferingIdandFeatureId extends BornInCloudTestBase{
	
	public Test_REST_GetEntitlement_OfferingIdandFeatureId() throws IOException {
	...
	@Test
	public void Test_REST_GetEntitlement_OfferingIdandFeatureId_Method() throws Exception {		
		...
		HttpResponse response = getEntitlement(client,testDataMap.get("url"), testDataMap.get("userId"), "?offeringId=FSN360-TRIAL&featureId=FSN360");
