 ...
 * @version 1.0.0
 */
public final class Test_REST_GetEntitlement_FeatureId extends BornInCloudTestBase{
	
	public Test_REST_GetEntitlement_FeatureId() throws IOException {
	...
	@Test
	public void Test_REST_GetEntitlement_FeatureId_Method() throws Exception {		
		...
		HttpResponse response = getEntitlement(client, testDataMap.get("url"), testDataMap.get("userId"), "?featureId=FSN360");
