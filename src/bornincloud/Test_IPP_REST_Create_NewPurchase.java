 ...
 * @version 1.0.0
 */
public final class Test_IPP_REST_Create_NewPurchase extends BornInCloudTestBase {
	...
	public Test_IPP_REST_Create_NewPurchase() throws IOException {
	...
	@Test
	public void Test_IPP_REST_Create_NewPurchase_Method() throws Exception {
		...
		// Parsing test data values from test data file and creating a test data Hash
				...
				HttpResponse response = createEntitlement(client, testDataMap.get("ippRequest"), firstName+testDataMap.get("userId"), actualRequestJson, testDataMap.get("jsonMimetype"));	
