 ...
 * @version 1.0.0
 */
public final class Test_REST_CreateEntitlement_EnthusiastOffering extends BornInCloudTestBase {
	
	public Test_REST_CreateEntitlement_EnthusiastOffering() throws IOException {
	...
	@Test
	public void Test_REST_CreateEntitlement_EnthusiastOffering_Method() throws Exception {
	    ...
	    Map<String,String> UserEntMap = createEntMap(actualjsondata, testDataMap.get("userId"), "Actual", "Create", "Enthusiast");
	    
	    String expectedjsondata = readJsonFromoffering(testDataMap.get("offTable1"));
	    Map<String,String> OffrEntMap = createEntMap(expectedjsondata, testDataMap.get("userId"), "Expected", "Create", "Enthusiast");			
