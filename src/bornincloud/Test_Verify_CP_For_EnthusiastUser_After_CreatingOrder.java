...
public class Test_Verify_CP_For_EnthusiastUser_After_CreatingOrder extends BornInCloudTestBase{
	
	public String sessionID;	
	public String  userID;
	
	public Test_Verify_CP_For_EnthusiastUser_After_CreatingOrder() throws IOException {
	...
	public void Test_Verify_CP_For_Enthusiast_User_Method() throws Exception {
		...
		Util.sleep(5000);
		portalValidationsForUser(userID, "Password1","Enthusiast");
