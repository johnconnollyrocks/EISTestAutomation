...
public class Test_Verify_CP_For_EnthusiastUser_After_CreatingOrderThroughIPP extends BornInCloudTestBase{
	
	public String sessionID;	
	public String  userID;
	public String  url;
	
	public Test_Verify_CP_For_EnthusiastUser_After_CreatingOrderThroughIPP() throws IOException {
	...
	@Test
	public void Test_Verify_CP_For_EnthusiastUser_Method() throws Exception {
		...
		launchIPP(url);
		IPPOrderCreate(userID,"enthusiast");
		Util.sleep(5000);
