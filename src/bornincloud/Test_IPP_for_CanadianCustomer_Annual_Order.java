 ...
 * @version 1.0.0
 */
public final class Test_IPP_for_CanadianCustomer_Annual_Order extends BornInCloudTestBase {
	
	public Test_IPP_for_CanadianCustomer_Annual_Order() throws IOException {
		super("browser");
	...
	@Test
	public void Test_IPP_for_CanadianCustomer_Annual_Order_Method() throws Exception {
			...
			if (homePage.checkIfElementExistsInPage("orderNumTxt", 10)){
				assertTrueCatchException("Sucessfully navigated to order page. ",homePage.checkIfElementExistsInPage("orderNumTxt", 10));
			}else{
