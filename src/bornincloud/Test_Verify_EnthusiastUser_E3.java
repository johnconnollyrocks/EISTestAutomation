...
public class Test_Verify_EnthusiastUser_E3 extends BornInCloudTestBase {

	public Test_Verify_EnthusiastUser_E3() {
		super("browser");
	...
	public void Test_Verify_EnthusiastUser() throws Exception {
		...
		if (!service_fusion) {
			assertTrueCatchException(
					"Fusion 360 Enthusiast Not Displayed in Services", false);
		...
		if (!product_fusion) {
			assertTrueCatchException(
					"Fusion 360 Enthusiast Not Displayed in Product", true);
