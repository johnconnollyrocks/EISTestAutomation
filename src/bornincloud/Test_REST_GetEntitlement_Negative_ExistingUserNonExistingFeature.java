...
/**
 * Test class - Test_REST_GetEntitlement_Negative_ExistingUserNonExistingFeature
 * 
 * @author Brijesh Chavda
 * @version 1.0.0
 */
public final class Test_REST_GetEntitlement_Negative_ExistingUserNonExistingFeature extends BornInCloudTestBase{
	
	public Test_REST_GetEntitlement_Negative_ExistingUserNonExistingFeature() throws IOException {
	...
	@Test
	public void Test_REST_GetEntitlement_Negative_ExistingUserNonExistingFeature_Method() throws Exception {		
		...
		HttpResponse response = getEntitlement(client, testDataMap.get("url"), testDataMap.get("userId"), "?featureId=none");
