 ...
 * @version 1.0.0
 */
public final class Test_REST_GetEntitlement_ExpiredTrueandOfferingId extends BornInCloudTestBase{
	
	public Test_REST_GetEntitlement_ExpiredTrueandOfferingId() throws IOException {
	...
	@Test
	public void Test_REST_GetEntitlement_ExpiredTrueandOfferingId_Method() throws Exception {
		...
		HttpResponse response = getEntitlement(client, testDataMap.get("url"), testDataMap.get("userId"), "?includeExpired=true&offeringId=FSN360-TRIAL");
