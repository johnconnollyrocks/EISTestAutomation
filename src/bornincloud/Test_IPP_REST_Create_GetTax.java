 ...
 * @version 1.0.0
 */
public final class Test_IPP_REST_Create_GetTax extends BornInCloudTestBase {
	...
	public Test_IPP_REST_Create_GetTax() throws IOException {
	...
	@Test
	public void Test_IPP_REST_GetTax() throws Exception {
...
//			    compareStrings(testDataMap.get("expectedjsondata").trim().replace(" ", ""), actualjsondata.trim().replace(" ", ""));
