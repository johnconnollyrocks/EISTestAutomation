 ...
 * @version 1.0.0
 */
public final class Test_REST_GetEntitlement_Negative_NonExistingUser extends BornInCloudTestBase{
	
	public Test_REST_GetEntitlement_Negative_NonExistingUser() throws IOException {
	...
	@Test
	public void Test_REST_GetEntitlement_Negative_NonExistingUser_Method() throws Exception {		
		...
		HttpResponse response = getEntitlement(client,testDataMap.get("url"), testDataMap.get("userId"), "");
