 ...
 * @version 1.0.0
 */
public final class Test_REST_GetEntitlement_OfferingId extends BornInCloudTestBase{
	
	public Test_REST_GetEntitlement_OfferingId() throws IOException {
	...
	@Test
	public void Test_REST_GetEntitlement_OfferingId_Method() throws Exception {		
		...
		HttpResponse response = getEntitlement(client,testDataMap.get("url"), testDataMap.get("userId"), "?offeringId=FSN360-TRIAL");
