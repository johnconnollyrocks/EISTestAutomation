 ...
 * @version 1.0.0
 */
public final class Test_BUUC_REST_ConvergentCharging_Casual extends BornInCloudTestBase{
	String response="";
	String contract="";
	String Request="";
	...
	public Test_BUUC_REST_ConvergentCharging_Casual() throws IOException {
	...
	@Test
	public void Test_BUUC_REST_ConvergentCharging_Casual_Method() throws Exception {	
		...
		for(int i=0;i<contentArr.length;i++){	
			...
			if(contentArr[i].contains("stopTime")){
				contentArr[i]="\"stopTime\""+":"+"\""+newDate+" 13:59:00"+"\""+"}";				
			}
