 ...
 * @version 1.0.0
 */
public final class Test_BUUC_REST_ConvergentCharging_PrevYr_Olderthan1Yr extends BornInCloudTestBase{
	String response="";
	String contract="";
	String Request="";
	...
	public Test_BUUC_REST_ConvergentCharging_PrevYr_Olderthan1Yr() throws IOException {
	...
	@Test
	public void Test_BUUC_REST_ConvergentCharging_PrevYr_Olderthan1Yr_Method() throws Exception {	
