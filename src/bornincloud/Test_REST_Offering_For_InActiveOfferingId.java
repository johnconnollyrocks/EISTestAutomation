 ...
 * @version 1.0.0
 */
public final class Test_REST_Offering_For_InActiveOfferingId extends BornInCloudTestBase{
	
	public Test_REST_Offering_For_InActiveOfferingId() throws IOException {
	...
	@Test
	public void Test_REST_Offering_For_InActiveOfferingId() throws Exception {		
		...
		compareStrings(testDataMap.get("expectedjsondata").replaceAll(" ", ""), actualjsondata.replaceAll(" ", ""));
