...
public class Test_AmazonRental_instantaccess_OrderCreation_WebService extends
		AmazonRentalTestBase {

	private final Log log = LogFactory
			.getLog(Test_AmazonRental_instantaccess_OrderCreation_WebService.class);
	...
	public Test_AmazonRental_instantaccess_OrderCreation_WebService()
			throws IOException {
	...
	private  void run() throws SigningException, SerializationException,
		...
		for (int i = 0; i < productLines.size(); i++) {
			...
			String SubscriptionID = getAlphanumericText(8) + "-" + getAlphanumericText(4)
					+ "-" + getAlphanumericText(4) + "-" + getAlphanumericText(12);
		...
		System.out.println("Activate Subscription is done for the  ID's  "+SubscriptionIDGroup);
	}
