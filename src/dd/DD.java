 ...
 * @version 1.0.0
 */
final class DD extends SFDCObject {
	//State variables 
	 ...
	 */
	public DD(Window_ myDocumentsPopUp, Page_ myDocumentsPage, Page_ viewContactPage) {
	...
	protected List<String> getProductLines() {
		return getProductLines(DDConstants.DD_PRODUCT_LINE_CONSTANT_SET_NAME);
	}
...
*/
	...
	protected List<String> getProductLinePanelFieldNames() {
		return getProductLinePanelFieldNames(DDConstants.DD_PRODUCT_LINE_CONSTANT_SET_NAME);
	}
	...
	protected List<String> getProductLineYearVersionFieldNamesExpected() {
		return getProductLineYearVersionFieldNamesExpected(DDConstants.DD_PRODUCT_LINE_YEAR_VERSIONS_CONSTANT_SET_NAME);
	}
	...
	protected List<String> getProductLineYearVersionFieldNamesSuperset(List<String> productLines) {
		...
		for (int year = DDConstants.PRODUCT_VERSION_MIN_YEAR; year <= DDConstants.PRODUCT_VERSION_MAX_YEAR; year++) {
	...
	protected List<String> getFileNamesExpected(String yearVersion) {
		return getFileNamesExpected(DDConstants.DD_FILE_NAMES_YEAR_VERSION_CONSTANT_SET_NAME_PREFIX, yearVersion);
	}
	
	protected List<String> getTabFieldNames(List<String> productLines) {
		return getProductLinePanelContentFieldNames(productLines, DDConstants.TAB_FIELD_NAMES);
	}
...
*/
	...
	protected List<String> getFileDetailsButtonFieldNames(List<String> productLines) {
		return getProductLinePanelContentFieldNames(productLines, DDConstants.FILE_DETAILS_BUTTON_FIELD_NAMES);
	}
	
	protected List<String> getFileDetailsDropDownValuesFieldNames(List<String> productLines) {
		return getProductLinePanelContentFieldNames(productLines, DDConstants.FILE_DETAILS_DROP_DOWN_VALUES_FIELD_NAMES);
	}
