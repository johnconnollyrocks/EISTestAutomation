...
/**
 * Test class - TestVerifyContractFilterList
 * 
 * @author Nithya Somasundaram
 * @version 1.0.0
 */
public final class TestVerifyContractFilterList extends CEPTestBase {
	public TestVerifyContractFilterList() throws IOException {
		super("firefox");
	}
	...
	@Test
	public void TEST_ContractFilterList() throws Exception {
		...
		String xpath = "//div[@id='filtersPanel']/div[2]/div[5]/div[2]/ul/li[3]/div/div[1]";
