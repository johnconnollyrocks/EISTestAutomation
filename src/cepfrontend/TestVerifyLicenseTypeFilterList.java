...
/**
 * Test class - TestVerifyLicenseTypeFilterList
 * 
 * @author Nithya Somasundaram
 * @version 1.0.0
 */
public final class TestVerifyLicenseTypeFilterList extends CEPTestBase {
	public TestVerifyLicenseTypeFilterList() throws IOException {
		super("firefox");
	}
	...
	@Test
	public void TEST_LicenseTypeFilterList() throws Exception {
