...
/**
 * Test class - TestVerifySubscriptionFilterList
 * 
 * @author Nithya Somasundaram
 * @version 1.0.0
 */
public final class TestVerifySubscriptionFilterList extends CEPTestBase {
	public TestVerifySubscriptionFilterList() throws IOException {
		super("firefox");
	}
	...
	@Test
	public void TEST_SubscriptionFilterList() throws Exception {
