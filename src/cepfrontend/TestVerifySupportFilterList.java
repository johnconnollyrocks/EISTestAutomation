...
/**
 * Test class - TestVerifySupportFilterList
 * 
 * @author Nithya Somasundaram
 * @version 1.0.0
 */
public final class TestVerifySupportFilterList extends CEPTestBase {
	public TestVerifySupportFilterList() throws IOException {
		super("firefox");
	}
	...
	@Test
	public void TEST_SupportFilterList() throws Exception {
		...
		String xpath = "//div[@id='filtersPanel']/div[2]/div[7]/div[2]/ul/li[1]/div/div[1]";
