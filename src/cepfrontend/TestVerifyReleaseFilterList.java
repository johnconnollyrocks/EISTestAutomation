...
/**
 * Test class - TestVerifyReleaseFilterList
 * 
 * @author Nithya Somasundaram
 * @version 1.0.0
 */
public final class TestVerifyReleaseFilterList extends CEPTestBase {
	public TestVerifyReleaseFilterList() throws IOException {
		super("firefox");
	}
	...
	@Test
	public void TEST_ReleaseFilterList() throws Exception {
		...
		homePage.click("releaseMoreOptions");
