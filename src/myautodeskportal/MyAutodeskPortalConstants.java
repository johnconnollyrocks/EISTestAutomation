...
/**
 * Constants and enumerated types specific to MyAutodeskPortal application.
 * 
 * @author Vithyusha Revuri
 * @version 1.0.0
 */
final class MyAutodeskPortalConstants {
...
//	static final String AUTO_PASSWORD_STG = "Contractm1";
	...
	// filtering the list of users to only those used in MyAutodeskPortal testing)
