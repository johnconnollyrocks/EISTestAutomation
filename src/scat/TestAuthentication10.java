 ...
 * @version 1.0.0
 */
public final class TestAuthentication10 extends SCATTestBase {
	public TestAuthentication10() {
	...
	public void setUp() throws Exception {
		...
		launchSCAT(SCATConstants.BASE_URL10
				);
	}
	...
	public void TEST_Login() throws Exception {
		...
		Util.printInfo("Opened the url : " + SCATConstants.BASE_URL10);
