 ...
 * @version 1.0.0
 */
public final class TestAuthentication11 extends SCATTestBase {
	public TestAuthentication11() {
	...
	public void setUp() throws Exception {
		...
		launchSCAT(SCATConstants.BASE_URL11
				);
	}
	...
	public void TEST_Login() throws Exception {
		...
		Util.printInfo("Opened the url : " + SCATConstants.BASE_URL11);
