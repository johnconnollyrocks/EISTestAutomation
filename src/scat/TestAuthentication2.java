 ...
 * @version 1.0.0
 */
public final class TestAuthentication2 extends SCATTestBase {
	public TestAuthentication2() {
	...
	public void setUp() throws Exception {
		...
		launchSCAT(SCATConstants.BASE_URL2);
	}
	...
	public void TEST_Login() throws Exception {
		...
		Util.printInfo("Opened the url : " + SCATConstants.BASE_URL2);
