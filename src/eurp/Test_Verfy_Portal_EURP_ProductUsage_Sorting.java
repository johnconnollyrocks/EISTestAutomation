...
public class Test_Verfy_Portal_EURP_ProductUsage_Sorting extends EURPTestBase{

	public Test_Verfy_Portal_EURP_ProductUsage_Sorting() throws IOException {
...
//		super();
	...
	@Test
	public void Test_Verfy_Portal_EURP_ProductUsage_Sorting() throws Exception {
		...
		if(homePage.isFieldVisible("ProductUsage")){
			...
			Util.printInfo("Verifying sorting functionality in product usage page ");
			
			Util.printInfo("selecting view By :: " +homePage.getValueFromGUI("ViewByProducts"));
			
			homePage.click("ViewByProducts");
