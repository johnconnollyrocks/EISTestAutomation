...
/**
 * <p>Java class for ContractRefDataType complex type.
 * 
...
@XmlType(name = "ContractRefDataType", propOrder = {
    "contractNumber"
})
@XmlSeeAlso({
    ContractBaseDataType.class
})
public class ContractRefDataType {

    @XmlElementRef(name = "ContractNumber", namespace = "http://www.autodesk.com/schemas/Business/ContractV1.0", type = JAXBElement.class, required = false)
